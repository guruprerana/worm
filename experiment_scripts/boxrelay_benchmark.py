...
def risk_min():
    ...
    for e in es:
        ...
        # VaR baseline
        min_path, min_path_scores = baseline_var_estim(task_graph, e, n_samples)
...
def correlated_noise_experiment():
    ...
    noise_configs = [
        ...
        {"noise_min": 0.0, "noise_max": 200.0, "name": "max-200"},
        {"noise_min": 0.0, "noise_max": 400.0, "name": "max-400"},
    ]
