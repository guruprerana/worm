...
with open("experiments_data/car2d-policies/path_policies.pkl", "rb") as f:
    path_policies = pickle.load(f)

with open("experiments_data/car2d-policies/adj_list.pkl", "rb") as f:
    adj_list = pickle.load(f)

with open("experiments_data/car2d-policies/terminal_vertices.pkl", "rb") as f:
...
with open("experiments_data/car2d-spec9-cum-reward.json", "w") as json_file:
    json_file.write(json_data)

with open("experiments_data/car2d-policies/car2d-spec9-cum-rew-scoregraph.pkl", "wb") as f:
